 ...
 * Version 1.0.0
 *
 * Report of codings use -
 * This report lists which codings patients were given   within a given date range
 * and generates a csv of the results
 *
 * created by Ruth Moulton for Open-IT HSE project from report Patient_list.php authors Rod Roark and Brady Miller July 2023
  *
 * @package   OpenEMR
...
$report_title = xl("List of Patients' Codings");
...
<form name='theform' id='theform' method='post' action='patient_codes_use.php' onsubmit='return top.restoreSession()'>
...
if (!empty($_POST['form_refresh']) || !empty($_POST['form_csvexport'])) {
    ...
    } else { //not csv export - display on screen
        ?>
